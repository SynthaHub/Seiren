 ...
 *
 * lucide v1 removed third-party brand icons, so these are drawn here. Each is
 * used only to label a link that goes to that platform, which is what the mark
 * is for. All are single-path, `currentColor`, on the same 24-unit grid, so
 * they take the surrounding accent tokens like any other icon.
 */
...
export function TikTokIcon({ className }: IconProps) {
  return (
    <svg viewBox="0 0 24 24" fill="currentColor" aria-hidden="true" className={className}>
      <path d="M16.6 5.82A4.28 4.28 0 0 1 15.54 3h-3.09v12.4a2.59 2.59 0 0 1-2.59 2.5 2.59 2.59 0 0 1 0-5.18c.27 0 .52.04.76.12v-3.2a5.78 5.78 0 0 0-.76-.05A5.72 5.72 0 0 0 4.14 15.3 5.72 5.72 0 0 0 9.86 21a5.72 5.72 0 0 0 5.72-5.72V9.01a7.35 7.35 0 0 0 4.28 1.37V7.3a4.28 4.28 0 0 1-3.26-1.48Z" />
    </svg>
  );
}
